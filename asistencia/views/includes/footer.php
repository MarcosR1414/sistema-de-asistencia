          ...
          <div class="card">
            <div class="card-body">
              <div class="d-sm-flex justify-content-center justify-content-sm-between py-2">
                <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">blackboard Senati<a href="https://senati.blackboard.com/" target="_blank"> blackboard </a>2023</span>
                <span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center">SENATI SINFO <a href="https://sinfo.senati.edu.pe/" target="_blank"> SINFO </a> 2023</span>
              </div>
            </div>
          </div>
        </footer>
